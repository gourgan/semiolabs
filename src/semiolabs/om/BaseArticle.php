...
abstract class BaseArticle extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the auteur_id field.
     * @var        int
     */
    protected $auteur_id;
    ...
    /**
     * The value for the nb_vue field.
     * @var        int
     */
    protected $nb_vue;
    ...
    /**
     * Get the [auteur_id] column value.
     *
     * @return int
     */
    ...
    public function setTitre($v)
    {
        ...
        if ($this->titre !== $v) {
            $this->titre = $v;
            $this->modifiedColumns[] = ArticlePeer::TITRE;
        }
    ...
    public function setTexte($v)
    {
        ...
        if ($this->texte !== $v) {
            $this->texte = $v;
            $this->modifiedColumns[] = ArticlePeer::TEXTE;
        }
    ...
    public function setMedia($v)
    {
        ...
        if ($this->media !== $v) {
            $this->media = $v;
            $this->modifiedColumns[] = ArticlePeer::MEDIA;
        }
    ...
    public function setLien($v)
    {
        ...
        if ($this->lien !== $v) {
            $this->lien = $v;
            $this->modifiedColumns[] = ArticlePeer::LIEN;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = ArticlePeer::TYPE_ID;
        }
    ...
    /**
     * Set the value of [auteur_id] column.
     *
     * @param int $v new value
     * @return Article The current object (for fluent API support)
     */
    public function setAuteurId($v)
    {
        ...
        if ($this->auteur_id !== $v) {
            $this->auteur_id = $v;
            $this->modifiedColumns[] = ArticlePeer::AUTEUR_ID;
        }
    ...
    public function setTags($v)
    {
        ...
        if ($this->tags !== $v) {
            $this->tags = $v;
            $this->modifiedColumns[] = ArticlePeer::TAGS;
        }
    ...
    /**
     * Set the value of [nb_vue] column.
     *
     * @param int $v new value
     * @return Article The current object (for fluent API support)
     */
    public function setNbVue($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->nb_vue !== $v) {
            $this->nb_vue = $v;
            $this->modifiedColumns[] = ArticlePeer::NB_VUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->texte = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->date = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->media = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->lien = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->type_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->auteur_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->tags = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->nb_vue = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->resetModified();
            ...
            return $startcol + 10; // 10 = ArticlePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAuteur !== null && $this->auteur_id !== $this->aAuteur->getId()) {
            $this->aAuteur = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aAuteur !== null) {
                if ($this->aAuteur->isModified() || $this->aAuteur->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArticlePeer::TITRE)) {
            $modifiedColumns[':p' . $index++]  = '`titre`';
        }
        if ($this->isColumnModified(ArticlePeer::TEXTE)) {
            $modifiedColumns[':p' . $index++]  = '`texte`';
        }
        if ($this->isColumnModified(ArticlePeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(ArticlePeer::MEDIA)) {
            $modifiedColumns[':p' . $index++]  = '`media`';
        }
        if ($this->isColumnModified(ArticlePeer::LIEN)) {
            $modifiedColumns[':p' . $index++]  = '`lien`';
        }
        if ($this->isColumnModified(ArticlePeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`type_id`';
        }
        if ($this->isColumnModified(ArticlePeer::AUTEUR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`auteur_id`';
        }
        if ($this->isColumnModified(ArticlePeer::TAGS)) {
            $modifiedColumns[':p' . $index++]  = '`tags`';
        }
        if ($this->isColumnModified(ArticlePeer::NB_VUE)) {
            $modifiedColumns[':p' . $index++]  = '`nb_vue`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`type_id`':
                        ...
                        break;
                    case '`auteur_id`':
                        $stmt->bindValue($identifier, $this->auteur_id, PDO::PARAM_INT);
                        break;
                    case '`tags`':
                        $stmt->bindValue($identifier, $this->tags, PDO::PARAM_STR);
                        break;
                    case '`nb_vue`':
                        $stmt->bindValue($identifier, $this->nb_vue, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getTexte(),
            $keys[3] => $this->getDate(),
            $keys[4] => $this->getMedia(),
            $keys[5] => $this->getLien(),
            $keys[6] => $this->getTypeId(),
            $keys[7] => $this->getAuteurId(),
            $keys[8] => $this->getTags(),
            $keys[9] => $this->getNbVue(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->aType) {
                $result['Type'] = $this->aType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aAuteur) {
                $result['Auteur'] = $this->aAuteur->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setTexte($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setDate($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setMedia($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setLien($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTypeId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setAuteurId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTags($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setNbVue($arr[$keys[9]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticlePeer::TITRE)) $criteria->add(ArticlePeer::TITRE, $this->titre);
        if ($this->isColumnModified(ArticlePeer::TEXTE)) $criteria->add(ArticlePeer::TEXTE, $this->texte);
        if ($this->isColumnModified(ArticlePeer::DATE)) $criteria->add(ArticlePeer::DATE, $this->date);
        if ($this->isColumnModified(ArticlePeer::MEDIA)) $criteria->add(ArticlePeer::MEDIA, $this->media);
        if ($this->isColumnModified(ArticlePeer::LIEN)) $criteria->add(ArticlePeer::LIEN, $this->lien);
        if ($this->isColumnModified(ArticlePeer::TYPE_ID)) $criteria->add(ArticlePeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(ArticlePeer::AUTEUR_ID)) $criteria->add(ArticlePeer::AUTEUR_ID, $this->auteur_id);
        if ($this->isColumnModified(ArticlePeer::TAGS)) $criteria->add(ArticlePeer::TAGS, $this->tags);
        if ($this->isColumnModified(ArticlePeer::NB_VUE)) $criteria->add(ArticlePeer::NB_VUE, $this->nb_vue);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAuteurId($this->getAuteurId());
        $copyObj->setTags($this->getTags());
        $copyObj->setNbVue($this->getNbVue());
    ...
    /**
     * Declares an association between this object and a Auteur object.
     *
     * @param             Auteur $v
     * @return Article The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAuteur(Auteur $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Auteur object, it will not be re-added.
        if ($v !== null) {
            $v->addArticle($this);
        }
    ...
    /**
     * Get the associated Auteur object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Auteur The associated Auteur object.
     * @throws PropelException
     */
    public function getAuteur(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuteur === null && ($this->auteur_id !== null) && $doQuery) {
            $this->aAuteur = AuteurQuery::create()->findPk($this->auteur_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuteur->addArticles($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aAuteur instanceof Persistent) {
              $this->aAuteur->clearAllReferences($deep);
            }

...
abstract class BaseType extends BaseObject implements Persistent
{
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = TypePeer::LIBELLE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TypePeer::LIBELLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TypePeer::LIBELLE)) $criteria->add(TypePeer::LIBELLE, $this->libelle);
     ...
     * @return PropelObjectCollection|Article[] List of Article objects
     */
    public function getArticlesJoinAuteur($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ArticleQuery::create(null, $criteria);
        $query->joinWith('Auteur', $join_behavior);

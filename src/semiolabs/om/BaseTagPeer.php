...
abstract class BaseTagPeer
{
    ...
    {
        // Invalidate objects in TagArticlePeer instance pool,
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related TagArticle objects
            $criteria = new Criteria(TagArticlePeer::DATABASE_NAME);

            $criteria->add(TagArticlePeer::ID_TAG, $obj->getId());
            $affectedRows += TagArticlePeer::doDelete($criteria, $con);
        }
